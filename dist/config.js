...
export const config = {
    ...
    jiraForceIncludeKeys: (parsed.data.JIRA_FORCE_INCLUDE_KEYS ?? "")
        ...
        .filter(Boolean),
    hardBlockedKeywordPattern: /\b(api[ -]?keys?|secrets?|private keys?|token rotation|database migrations?|schema migrations?|data backfills?|infrastructure migrations?|terraform|kubernetes|helm|deploy(?:ment|ments)?|ci\/cd|github actions|billing|payment)\b/i,
